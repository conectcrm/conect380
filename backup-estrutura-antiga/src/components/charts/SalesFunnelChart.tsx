        ...
        {data.map((item, index) => {
          ...
          return (
            <div 
              ...
              className="group"
              role="listitem"
              aria-label={`${item.stage}: ${item.count} leads, ${conversionRate}% de conversão`}
            >
              ...
              <div className="relative">
                <div 
                  ...
                  aria-label={`${item.stage}: ${item.count} de ${maxValue} leads`}
                >
                  <div
                    className="h-full rounded-lg transition-all duration-300 ease-in-out group-hover:opacity-80"
                    style={{
                      width: `${percentage}%`,
          ...
          <div className="relative w-32 h-32">
            <svg className="w-32 h-32 transform -rotate-90" viewBox="0 0 36 36">
              ...
              <path
                ...
                stroke="#10b981"
                strokeWidth="2"
                strokeDasharray="27.6, 100"
                strokeDashoffset="25"
                transform="rotate(149 18 18)"
              />
              {/* Negociação - 20.7% */}
              <path
                d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831"
                ...
                stroke="#3b82f6"
                strokeWidth="2"
                strokeDasharray="20.7, 100"
                strokeDashoffset="25"
                transform="rotate(248 18 18)"
              />
            </svg>
            <div className="absolute inset-0 flex items-center justify-center">
