import { Menu, ShieldCheck, Users, Building2, Settings2, ClipboardList, LogOut } from 'lucide-react';
      ...
      <main className="main-panel">
        <header className="topbar">
          ...
          <div className="topbar-title">
            <h1>Backoffice de Governanca</h1>
            <p>Superficie administrativa dedicada para operacoes criticas.</p>
          </div>
        </header>
