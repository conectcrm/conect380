...
export const GovernanceDashboardPage = () => {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      try {
        const response = await api.get('/guardian/bff/overview');
  ...
  return (
    <div className="page-grid">
      <section className="card">
        ...
        <p className="subtle">
          Indicadores centralizados pelo gateway guardian (`/guardian/bff/overview`).
        </p>
      ...
      <section className="card">
        ...
        <ul className="clean-list">
          <li>App guardian separada em `guardian-web`.</li>
          <li>Autenticacao e guard de acesso superadmin.</li>
          <li>Menu dedicado para governanca (usuarios, empresas, auditoria e sistema).</li>
          <li>Base de deploy isolado preparada para subdominio `guardian.*`.</li>
        </ul>
      </section>
    </div>
  );
