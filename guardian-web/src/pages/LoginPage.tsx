...
export const LoginPage = () => {
  ...
  const handleLogin = async (event: FormEvent<HTMLFormElement>) => {
    ...
    setLoading(true);
    try {
      const outcome = await login(email.trim(), senha);
  ...
  return (
    <div className="login-shell">
      <section className="login-card">
        <header>
          <span className="pill">Conect360 Guardian</span>
          <h1>Acesso guardian</h1>
          <p>
            Ambiente dedicado para governanca e operacoes criticas. Perfil permitido: superadmin.
          </p>
        </header>
          ...
          <form onSubmit={handleLogin} className="form-grid">
            <label>
              ...
              <input
                ...
                placeholder="guardian@empresa.com"
                required
                autoComplete="email"
              />
            </label>
