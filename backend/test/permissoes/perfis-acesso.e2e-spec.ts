...
describe('Permissoes por Perfil (E2E)', () => {
  ...
  describe('matriz de acesso por recurso (read)', () => {
    const cenarios = [
      ...
      },
      {
        nome: 'crm clientes',
        route: '/clientes',
        allowedPerfis: ['gerente', 'vendedor', 'suporte', 'financeiro'],
      },
      {
  ...
  describe('matriz de acesso por recurso (write)', () => {
    ...
    const cenarios: WriteScenario[] = [
      ...
      {
        nome: 'financeiro.contas-pagar.create',
        method: 'post',
        route: '/contas-pagar',
        allowedPerfis: ['financeiro'],
        payload: {},
      ...
      {
        nome: 'financeiro.contas-pagar.registrar-pagamento',
        method: 'post',
        route: `/contas-pagar/${UNKNOWN_UUID}/registrar-pagamento`,
        allowedPerfis: ['financeiro'],
        payload: {},
      },
      {
        nome: 'financeiro.contas-pagar.aprovar',
        method: 'post',
        route: `/contas-pagar/${UNKNOWN_UUID}/aprovar`,
        allowedPerfis: ['financeiro'],
        payload: {},
      },
      {
        nome: 'financeiro.contas-pagar.aprovacoes.lote',
        method: 'post',
        route: '/contas-pagar/aprovacoes/lote',
        allowedPerfis: ['financeiro'],
        payload: {},
      },
      {
        nome: 'financeiro.contas-bancarias.create',
        method: 'post',
        route: '/contas-bancarias',
        allowedPerfis: ['financeiro'],
        payload: {},
      ...
      {
        nome: 'financeiro.conciliacao.importar',
        method: 'post',
        route: '/conciliacao-bancaria/importacoes',
        allowedPerfis: ['financeiro'],
        payload: {},
      ...
      {
        nome: 'financeiro.alertas.recalcular',
        method: 'post',
        route: '/financeiro/alertas-operacionais/recalcular',
        allowedPerfis: ['financeiro'],
        payload: {},
      },
      {
        nome: 'financeiro.alertas.ack',
        method: 'post',
        route: `/financeiro/alertas-operacionais/${UNKNOWN_UUID}/ack`,
        allowedPerfis: ['financeiro'],
        payload: {},
      },
    ];
