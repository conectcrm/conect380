...
describe('Guardian backend bypass hardening (E2E)', () => {
  ...
  it('nega acesso a core-admin/bff mesmo com headers forjados pelo frontend', async () => {
  ...
  it('nega acesso a core-admin/empresas mesmo com body tentando escalar role', async () => {
    await request(app.getHttpServer())
      .post('/core-admin/empresas')
      .set('Authorization', `Bearer ${adminAccessToken}`)
      .send({
        role: 'superadmin',
