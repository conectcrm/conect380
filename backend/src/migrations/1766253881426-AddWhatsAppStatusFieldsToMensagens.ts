...
export class AddWhatsAppStatusFieldsToMensagens1766253881426 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "propostas" DROP CONSTRAINT IF EXISTS "FK_propostas_oportunidade"`);
    ...
    await queryRunner.query(`ALTER TABLE "atendimento_templates" DROP CONSTRAINT IF EXISTS "fk_atendimento_templates_empresa"`);
    ...
    await queryRunner.query(`ALTER TABLE "atendimento_tickets" ADD "status" character varying(20) NOT NULL DEFAULT 'FILA'`);
    await queryRunner.query(`ALTER TABLE "atendimento_tickets" ALTER COLUMN "severity" DROP NOT NULL`);
    await queryRunner.query(`COMMENT ON COLUMN "oportunidades"."motivo_perda_detalhes" IS 'Detalhes do motivo de perda'`);
    await queryRunner.query(`ALTER TABLE "oportunidades" DROP COLUMN "concorrente_nome"`);
    await queryRunner.query(`ALTER TABLE "oportunidades" ADD "concorrente_nome" character varying(255)`);
    await queryRunner.query(`COMMENT ON COLUMN "oportunidades"."concorrente_nome" IS 'Nome do concorrente (se aplicável)'`);
    ...
    await queryRunner.query(`COMMENT ON COLUMN "oportunidades"."data_revisao" IS 'Data para reavaliar oportunidade perdida'`);
    await queryRunner.query(`COMMENT ON COLUMN "oportunidades"."data_ultima_mudanca_estagio" IS 'Data da última mudança de estágio'`);
    await queryRunner.query(`ALTER TABLE "oportunidades" ALTER COLUMN "data_ultima_mudanca_estagio" DROP DEFAULT`);
    await queryRunner.query(`ALTER TABLE "oportunidades" ALTER COLUMN "dias_no_estagio_atual" SET NOT NULL`);
    await queryRunner.query(`COMMENT ON COLUMN "oportunidades"."dias_no_estagio_atual" IS 'Dias no estágio atual'`);
    await queryRunner.query(`ALTER TABLE "oportunidades" ALTER COLUMN "precisa_atencao" SET NOT NULL`);
    await queryRunner.query(`COMMENT ON COLUMN "oportunidades"."precisa_atencao" IS 'Oportunidade precisa de atenção (SLA vencido)'`);
    ...
    await queryRunner.query(`ALTER TABLE "interacoes" ADD COLUMN IF NOT EXISTS "tipo" character varying(50)`); // NULLABLE primeiro
    await queryRunner.query(`UPDATE "interacoes" SET "tipo" = 'outro' WHERE "tipo" IS NULL`); // Preencher
    await queryRunner.query(`ALTER TABLE "interacoes" ALTER COLUMN "tipo" SET NOT NULL`);
    ...
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_5bf61006ffaf91d65209e19a53" ON "atendimento_tickets" ("assigned_level") `);
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_4924436e18456fea06a3bb311f" ON "atendimento_tickets" ("severity") `);
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_de0189e9fc08cd5284c0a461b7" ON "atendimento_tickets" ("status") `);
    ...
    await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_bc7490a4f33a653dcc2928d2cc" ON "dlq_reprocess_audit" ("fila", "created_at") `);
    await queryRunner.query(`DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'FK_a884ea95470c3dcc1aca2f4a1d8') THEN ALTER TABLE "propostas" ADD CONSTRAINT "FK_a884ea95470c3dcc1aca2f4a1d8" FOREIGN KEY ("oportunidade_id") REFERENCES "oportunidades"("id") ON DELETE NO ACTION ON UPDATE NO ACTION; END IF; END $$;`);
    await queryRunner.query(`DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'FK_9b8490bce74e62adb498b5ccbb6') THEN ALTER TABLE "faturas" ADD CONSTRAINT "FK_9b8490bce74e62adb498b5ccbb6" FOREIGN KEY ("contratoId") REFERENCES "contratos"("id") ON DELETE NO ACTION ON UPDATE NO ACTION; END IF; END $$;`);
    await queryRunner.query(`DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'FK_644bf709a39af5c760b98e56a06') THEN ALTER TABLE "faturas" ADD CONSTRAINT "FK_644bf709a39af5c760b98e56a06" FOREIGN KEY ("empresa_id") REFERENCES "empresas"("id") ON DELETE NO ACTION ON UPDATE NO ACTION; END IF; END $$;`);
    await queryRunner.query(`DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'FK_8c0598142d693273de9dd9efec7') THEN ALTER TABLE "interacoes" ADD CONSTRAINT "FK_8c0598142d693273de9dd9efec7" FOREIGN KEY ("empresa_id") REFERENCES "empresas"("id") ON DELETE NO ACTION ON UPDATE NO ACTION; END IF; END $$;`);
    await queryRunner.query(`DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'FK_92f1c5f6ce19d19e7426eaa6ff9') THEN ALTER TABLE "interacoes" ADD CONSTRAINT "FK_92f1c5f6ce19d19e7426eaa6ff9" FOREIGN KEY ("lead_id") REFERENCES "leads"("id") ON DELETE NO ACTION ON UPDATE NO ACTION; END IF; END $$;`);
    await queryRunner.query(`DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'FK_edfa8151295c0ca5d30935bcfad') THEN ALTER TABLE "interacoes" ADD CONSTRAINT "FK_edfa8151295c0ca5d30935bcfad" FOREIGN KEY ("contato_id") REFERENCES "contatos"("id") ON DELETE NO ACTION ON UPDATE NO ACTION; END IF; END $$;`);
    await queryRunner.query(`DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'FK_3c25b1558da997f7e23639060c9') THEN ALTER TABLE "interacoes" ADD CONSTRAINT "FK_3c25b1558da997f7e23639060c9" FOREIGN KEY ("responsavel_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION; END IF; END $$;`);
    await queryRunner.query(`DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'FK_b548380f6348e2c89156fcc35cb') THEN ALTER TABLE "atendimento_templates" ADD CONSTRAINT "FK_b548380f6348e2c89156fcc35cb" FOREIGN KEY ("empresa_id") REFERENCES "empresas"("id") ON DELETE CASCADE ON UPDATE NO ACTION; END IF; END $$;`);
    await queryRunner.query(`DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'FK_67d145612622c2d336286d96ab2') THEN ALTER TABLE "agenda_eventos" ADD CONSTRAINT "FK_67d145612622c2d336286d96ab2" FOREIGN KEY ("empresa_id") REFERENCES "empresas"("id") ON DELETE NO ACTION ON UPDATE NO ACTION; END IF; END $$;`);
    await queryRunner.query(`DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'FK_e4b733b749c8b7563b61f6e9e48') THEN ALTER TABLE "agenda_eventos" ADD CONSTRAINT "FK_e4b733b749c8b7563b61f6e9e48" FOREIGN KEY ("interacao_id") REFERENCES "interacoes"("id") ON DELETE NO ACTION ON UPDATE NO ACTION; END IF; END $$;`);
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "agenda_eventos" DROP CONSTRAINT "FK_e4b733b749c8b7563b61f6e9e48"`);
    await queryRunner.query(`ALTER TABLE "agenda_eventos" DROP CONSTRAINT "FK_67d145612622c2d336286d96ab2"`);
    await queryRunner.query(`ALTER TABLE "atendimento_templates" DROP CONSTRAINT "FK_b548380f6348e2c89156fcc35cb"`);
    await queryRunner.query(`ALTER TABLE "interacoes" DROP CONSTRAINT "FK_3c25b1558da997f7e23639060c9"`);
    await queryRunner.query(`ALTER TABLE "interacoes" DROP CONSTRAINT "FK_edfa8151295c0ca5d30935bcfad"`);
    await queryRunner.query(`ALTER TABLE "interacoes" DROP CONSTRAINT "FK_92f1c5f6ce19d19e7426eaa6ff9"`);
    await queryRunner.query(`ALTER TABLE "interacoes" DROP CONSTRAINT "FK_8c0598142d693273de9dd9efec7"`);
    await queryRunner.query(`ALTER TABLE "faturas" DROP CONSTRAINT "FK_644bf709a39af5c760b98e56a06"`);
    await queryRunner.query(`ALTER TABLE "faturas" DROP CONSTRAINT "FK_9b8490bce74e62adb498b5ccbb6"`);
    await queryRunner.query(`ALTER TABLE "propostas" DROP CONSTRAINT "FK_a884ea95470c3dcc1aca2f4a1d8"`);
    ...
    await queryRunner.query(`CREATE TYPE "public"."interacoes_tipo_enum" AS ENUM('chamada', 'email', 'reuniao', 'nota', 'outro')`);
    await queryRunner.query(`ALTER TABLE "interacoes" ADD "tipo" "public"."interacoes_tipo_enum" NOT NULL`);
    ...
    await queryRunner.query(`ALTER TABLE "oportunidades" ALTER COLUMN "precisa_atencao" DROP NOT NULL`);
    await queryRunner.query(`COMMENT ON COLUMN "oportunidades"."dias_no_estagio_atual" IS NULL`);
    await queryRunner.query(`ALTER TABLE "oportunidades" ALTER COLUMN "dias_no_estagio_atual" DROP NOT NULL`);
    await queryRunner.query(`ALTER TABLE "oportunidades" ALTER COLUMN "data_ultima_mudanca_estagio" SET DEFAULT now()`);
    await queryRunner.query(`COMMENT ON COLUMN "oportunidades"."data_ultima_mudanca_estagio" IS NULL`);
    await queryRunner.query(`COMMENT ON COLUMN "oportunidades"."data_revisao" IS 'Data para reavaliar oportunidade perdida'`);
    await queryRunner.query(`ALTER TABLE "oportunidades" DROP COLUMN "data_revisao"`);
    ...
    await queryRunner.query(`ALTER TABLE "atendimento_tickets" ALTER COLUMN "severity" SET NOT NULL`);
    await queryRunner.query(`ALTER TABLE "atendimento_tickets" DROP COLUMN "status"`);
    await queryRunner.query(`CREATE TYPE "public"."atendimento_tickets_status_enum" AS ENUM('FILA', 'EM_ATENDIMENTO', 'ENVIO_ATIVO', 'ENCERRADO')`);
    await queryRunner.query(`ALTER TABLE "atendimento_tickets" ADD "status" "public"."atendimento_tickets_status_enum" NOT NULL DEFAULT 'FILA'`);
    ...
    await queryRunner.query(`ALTER TABLE "faturas" ADD "criadoPor" uuid`);
    await queryRunner.query(`ALTER TABLE "faturas" ADD "atualizadoPor" uuid`);
    await queryRunner.query(`CREATE INDEX "IDX_agenda_eventos_created_at" ON "agenda_eventos" ("created_at") `);
    await queryRunner.query(`CREATE INDEX "IDX_agenda_eventos_interacao_id" ON "agenda_eventos" ("interacao_id") `);
    await queryRunner.query(`CREATE INDEX "IDX_agenda_eventos_prioridade" ON "agenda_eventos" ("prioridade") `);
    await queryRunner.query(`CREATE INDEX "IDX_agenda_eventos_status" ON "agenda_eventos" ("status") `);
    await queryRunner.query(`CREATE INDEX "IDX_agenda_eventos_inicio" ON "agenda_eventos" ("inicio") `);
    await queryRunner.query(`CREATE INDEX "IDX_agenda_eventos_empresa_id" ON "agenda_eventos" ("empresa_id") `);
    await queryRunner.query(`CREATE INDEX "IDX_dlq_reprocess_fila_created_at" ON "dlq_reprocess_audit" ("fila", "created_at") `);
    ...
    await queryRunner.query(`CREATE INDEX "IDX_interacoes_agenda_event_id" ON "interacoes" ("agenda_event_id") `);
    await queryRunner.query(`CREATE INDEX "IDX_interacoes_created_at" ON "interacoes" ("created_at") `);
    await queryRunner.query(`CREATE INDEX "IDX_interacoes_data_referencia" ON "interacoes" ("data_referencia") `);
    await queryRunner.query(`CREATE INDEX "IDX_interacoes_responsavel_id" ON "interacoes" ("responsavel_id") `);
    await queryRunner.query(`CREATE INDEX "IDX_interacoes_contato_id" ON "interacoes" ("contato_id") `);
    ...
    await queryRunner.query(`CREATE INDEX "IDX_interacoes_empresa_id" ON "interacoes" ("empresa_id") `);
    ...
    await queryRunner.query(`CREATE INDEX "idx_propostas_oportunidade_id" ON "propostas" ("oportunidade_id") WHERE (oportunidade_id IS NOT NULL)`);
    ...
    await queryRunner.query(`CREATE INDEX "idx_oportunidades_dias_estagio" ON "oportunidades" ("estagio", "dias_no_estagio_atual") `);
    await queryRunner.query(`CREATE INDEX "idx_oportunidades_precisa_atencao" ON "oportunidades" ("precisa_atencao") WHERE (precisa_atencao = true)`);
    await queryRunner.query(`CREATE INDEX "IDX_atendimento_tickets_sla_expires_at" ON "atendimento_tickets" ("sla_expires_at") `);
    await queryRunner.query(`CREATE INDEX "IDX_atendimento_tickets_assigned_level" ON "atendimento_tickets" ("assigned_level") `);
    await queryRunner.query(`CREATE INDEX "IDX_atendimento_tickets_severity" ON "atendimento_tickets" ("severity") `);
    await queryRunner.query(`ALTER TABLE "agenda_eventos" ADD CONSTRAINT "FK_agenda_eventos_empresa" FOREIGN KEY ("empresa_id") REFERENCES "empresas"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    await queryRunner.query(`ALTER TABLE "agenda_eventos" ADD CONSTRAINT "FK_agenda_eventos_interacao" FOREIGN KEY ("interacao_id") REFERENCES "interacoes"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    ...
    await queryRunner.query(`ALTER TABLE "interacoes" ADD CONSTRAINT "FK_interacoes_empresa" FOREIGN KEY ("empresa_id") REFERENCES "empresas"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    await queryRunner.query(`ALTER TABLE "interacoes" ADD CONSTRAINT "FK_interacoes_lead" FOREIGN KEY ("lead_id") REFERENCES "leads"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    await queryRunner.query(`ALTER TABLE "interacoes" ADD CONSTRAINT "FK_interacoes_contato" FOREIGN KEY ("contato_id") REFERENCES "contatos"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    await queryRunner.query(`ALTER TABLE "interacoes" ADD CONSTRAINT "FK_interacoes_responsavel" FOREIGN KEY ("responsavel_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    await queryRunner.query(`ALTER TABLE "propostas" ADD CONSTRAINT "FK_propostas_oportunidade" FOREIGN KEY ("oportunidade_id") REFERENCES "oportunidades"("id") ON DELETE SET NULL ON UPDATE CASCADE`);
  }
