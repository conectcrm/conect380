...
export class AddWhatsAppStatusFieldsToMensagens1766253881426 implements MigrationInterface {
  name = 'AddWhatsAppStatusFieldsToMensagens1766253881426';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "propostas" DROP CONSTRAINT IF EXISTS "FK_propostas_oportunidade"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "atendimento_templates" DROP CONSTRAINT IF EXISTS "fk_atendimento_templates_empresa"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX IF EXISTS "public"."IDX_atendimento_tickets_assigned_level"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "public"."IDX_atendimento_tickets_sla_expires_at"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "atendimento_tickets" ADD "status" character varying(20) NOT NULL DEFAULT 'FILA'`,
    );
    await queryRunner.query(
      `ALTER TABLE "atendimento_tickets" ALTER COLUMN "severity" DROP NOT NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "oportunidades" ADD "concorrente_nome" character varying(255)`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(`ALTER TABLE "oportunidades" ADD "data_revisao" date`);
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "oportunidades" ALTER COLUMN "data_ultima_mudanca_estagio" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "oportunidades" ALTER COLUMN "dias_no_estagio_atual" SET NOT NULL`,
    );
    await queryRunner.query(
      `COMMENT ON COLUMN "oportunidades"."dias_no_estagio_atual" IS 'Dias no estágio atual'`,
    );
    await queryRunner.query(
      `ALTER TABLE "oportunidades" ALTER COLUMN "precisa_atencao" SET NOT NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(`ALTER TABLE "interacoes" DROP COLUMN IF EXISTS "tipo"`);
    await queryRunner.query(`DROP TYPE IF EXISTS "public"."interacoes_tipo_enum"`);
    await queryRunner.query(
      `ALTER TABLE "interacoes" ADD COLUMN IF NOT EXISTS "tipo" character varying(50)`,
    ); // NULLABLE primeiro
    await queryRunner.query(`
      DO $$
      BEGIN
      ...
      $$
    `); // Preencher
    await queryRunner.query(`ALTER TABLE IF EXISTS "interacoes" ALTER COLUMN "tipo" SET NOT NULL`);
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'FK_a884ea95470c3dcc1aca2f4a1d8') THEN ALTER TABLE "propostas" ADD CONSTRAINT "FK_a884ea95470c3dcc1aca2f4a1d8" FOREIGN KEY ("oportunidade_id") REFERENCES "oportunidades"("id") ON DELETE NO ACTION ON UPDATE NO ACTION; END IF; END $$;`,
    );
    if (hasFaturas) {
      await queryRunner.query(
    ...
    await queryRunner.query(
      `DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'FK_8c0598142d693273de9dd9efec7') THEN ALTER TABLE "interacoes" ADD CONSTRAINT "FK_8c0598142d693273de9dd9efec7" FOREIGN KEY ("empresa_id") REFERENCES "empresas"("id") ON DELETE NO ACTION ON UPDATE NO ACTION; END IF; END $$;`,
    );
    await queryRunner.query(
      `DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'FK_92f1c5f6ce19d19e7426eaa6ff9') THEN ALTER TABLE "interacoes" ADD CONSTRAINT "FK_92f1c5f6ce19d19e7426eaa6ff9" FOREIGN KEY ("lead_id") REFERENCES "leads"("id") ON DELETE NO ACTION ON UPDATE NO ACTION; END IF; END $$;`,
    );
    await queryRunner.query(
      `DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'FK_edfa8151295c0ca5d30935bcfad') THEN ALTER TABLE "interacoes" ADD CONSTRAINT "FK_edfa8151295c0ca5d30935bcfad" FOREIGN KEY ("contato_id") REFERENCES "contatos"("id") ON DELETE NO ACTION ON UPDATE NO ACTION; END IF; END $$;`,
    );
    await queryRunner.query(
      `DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'FK_3c25b1558da997f7e23639060c9') THEN ALTER TABLE "interacoes" ADD CONSTRAINT "FK_3c25b1558da997f7e23639060c9" FOREIGN KEY ("responsavel_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION; END IF; END $$;`,
    );
    await queryRunner.query(
      `DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'FK_b548380f6348e2c89156fcc35cb') THEN ALTER TABLE "atendimento_templates" ADD CONSTRAINT "FK_b548380f6348e2c89156fcc35cb" FOREIGN KEY ("empresa_id") REFERENCES "empresas"("id") ON DELETE CASCADE ON UPDATE NO ACTION; END IF; END $$;`,
    );
    await queryRunner.query(
      `DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'FK_67d145612622c2d336286d96ab2') THEN ALTER TABLE "agenda_eventos" ADD CONSTRAINT "FK_67d145612622c2d336286d96ab2" FOREIGN KEY ("empresa_id") REFERENCES "empresas"("id") ON DELETE NO ACTION ON UPDATE NO ACTION; END IF; END $$;`,
    );
    await queryRunner.query(
      `DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'FK_e4b733b749c8b7563b61f6e9e48') THEN ALTER TABLE "agenda_eventos" ADD CONSTRAINT "FK_e4b733b749c8b7563b61f6e9e48" FOREIGN KEY ("interacao_id") REFERENCES "interacoes"("id") ON DELETE NO ACTION ON UPDATE NO ACTION; END IF; END $$;`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "atendimento_templates" DROP CONSTRAINT "FK_b548380f6348e2c89156fcc35cb"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "configuracoes_gateway_pagamento" ALTER COLUMN "metodos_permitidos" SET DEFAULT '[]'`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "configuracoes_gateway_pagamento" ALTER COLUMN "credenciais" SET DEFAULT '{}'`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "transacoes_gateway_pagamento" ALTER COLUMN "payload_resposta" SET DEFAULT '{}'`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "transacoes_gateway_pagamento" ALTER COLUMN "payload_envio" SET DEFAULT '{}'`,
    );
