...
export class CreateEmpresaConfiguracoes1762211047321 implements MigrationInterface {
  name = 'CreateEmpresaConfiguracoes1762211047321';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    if (tabelaConfiguracoesExiste) {
      console.log(
        '⚠️  Tabela "empresa_configuracoes" já existe. Migration 1762211047321 será ignorada.',
      );
      return;
    }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    if (!tabelaConfiguracoesExiste) {
      console.log(
        'ℹ️  Tabela "empresa_configuracoes" não existe. Reversão 1762211047321 ignorada.',
      );
      return;
    }
