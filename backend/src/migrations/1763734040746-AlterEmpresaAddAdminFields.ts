...
export class AlterEmpresaAddAdminFields1763734040746 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // ⚡ MULTI-TENANT: Criar política de isolamento (idempotente)
    await queryRunner.query(`
      DO $$
      BEGIN
        IF NOT EXISTS (
    ...
    if (faturasExists) {
      ...
      await queryRunner.query(
        `ALTER TABLE "faturas" ALTER COLUMN "empresa_id" TYPE uuid USING "empresa_id"::uuid`,
      );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    const eventosFluxoExists = await queryRunner.hasTable('eventos_fluxo');
    ...
    if (faturasExists) {
      await queryRunner.query(
        `ALTER TABLE "faturas" ALTER COLUMN "valorMulta" TYPE numeric(10,2)`,
      );
      await queryRunner.query(
        `ALTER TABLE "faturas" ALTER COLUMN "valorJuros" TYPE numeric(10,2)`,
      );
      await queryRunner.query(
        `ALTER TABLE "faturas" ALTER COLUMN "valorDesconto" TYPE numeric(10,2)`,
      );
      await queryRunner.query(
        `ALTER TABLE "faturas" ALTER COLUMN "valorPago" TYPE numeric(10,2)`,
      );
      await queryRunner.query(
        `ALTER TABLE "faturas" ALTER COLUMN "valorTotal" TYPE numeric(10,2)`,
      );
