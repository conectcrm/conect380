...
export class AddPhase1ConfigFields1762212773553 implements MigrationInterface {
  name = 'AddPhase1ConfigFields1762212773553';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    if (tabelaConfiguracoesExiste) {
      console.log(
        '⚠️  Tabela "empresa_configuracoes" já existe. Migration 1762212773553 será ignorada.',
      );
      return;
    }
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."empresa_configuracoes_sms_provider_enum" AS ENUM('twilio', 'nexmo', 'sinch')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."empresa_configuracoes_push_provider_enum" AS ENUM('fcm', 'apns', 'onesignal')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."empresa_configuracoes_backup_frequencia_enum" AS ENUM('diario', 'semanal', 'mensal')`,
    );
    await queryRunner.query(
      `CREATE TABLE "empresa_configuracoes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "empresa_id" uuid NOT NULL, "descricao" character varying, "site" character varying, "logo_url" character varying, "cor_primaria" character varying NOT NULL DEFAULT '#159A9C', "cor_secundaria" character varying NOT NULL DEFAULT '#002333', "autenticacao_2fa" boolean NOT NULL DEFAULT false, "sessao_expiracao_minutos" integer NOT NULL DEFAULT '30', "senha_complexidade" "public"."empresa_configuracoes_senha_complexidade_enum" NOT NULL DEFAULT 'media', "auditoria" boolean NOT NULL DEFAULT true, "force_ssl" boolean NOT NULL DEFAULT true, "ip_whitelist" jsonb, "limite_usuarios" integer NOT NULL DEFAULT '10', "aprovacao_novo_usuario" boolean NOT NULL DEFAULT false, "convite_expiracao_horas" integer NOT NULL DEFAULT '48', "emails_habilitados" boolean NOT NULL DEFAULT true, "servidor_smtp" character varying, "porta_smtp" integer NOT NULL DEFAULT '587', "smtp_usuario" character varying, "smtp_senha" character varying, "whatsapp_habilitado" boolean NOT NULL DEFAULT false, "whatsapp_numero" character varying, "whatsapp_api_token" character varying, "sms_habilitado" boolean NOT NULL DEFAULT false, "sms_provider" "public"."empresa_configuracoes_sms_provider_enum", "sms_api_key" character varying, "push_habilitado" boolean NOT NULL DEFAULT false, "push_provider" "public"."empresa_configuracoes_push_provider_enum", "push_api_key" character varying, "api_habilitada" boolean NOT NULL DEFAULT false, "webhooks_ativos" integer NOT NULL DEFAULT '0', "backup_automatico" boolean NOT NULL DEFAULT true, "backup_frequencia" "public"."empresa_configuracoes_backup_frequencia_enum" NOT NULL DEFAULT 'diario', "backup_retencao_dias" integer NOT NULL DEFAULT '30', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_2844f1ff024c808097a812fde9d" PRIMARY KEY ("id"))`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    if (!tabelaConfiguracoesExiste) {
      console.log(
        'ℹ️  Tabela "empresa_configuracoes" não existe. Reversão 1762212773553 ignorada.',
      );
      return;
    }
    ...
    await queryRunner.query(`DROP TYPE "public"."empresa_configuracoes_push_provider_enum"`);
    await queryRunner.query(`DROP TYPE "public"."empresa_configuracoes_sms_provider_enum"`);
