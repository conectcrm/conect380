...
export class AddSeverityToTickets1765278941399 implements MigrationInterface {
  name = 'AddSeverityToTickets1765278941399';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE IF NOT EXISTS "dlq_reprocess_audit" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "action_id" character varying NOT NULL, "actor" character varying, "fila" character varying NOT NULL, "filters" jsonb, "total_filtrados" integer NOT NULL DEFAULT '0', "total_selecionados" integer NOT NULL DEFAULT '0', "reprocessados" integer NOT NULL DEFAULT '0', "ignorados_sem_job_name" integer NOT NULL DEFAULT '0', "ignorados_sem_payload" integer NOT NULL DEFAULT '0', "ignorados_job_name_invalido" integer NOT NULL DEFAULT '0', "ignorados_max_attempt" integer NOT NULL DEFAULT '0', "status" character varying NOT NULL DEFAULT 'success', "sample_jobs" jsonb, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_2ba3cab0b7663ec2d334ce344da" UNIQUE ("action_id"), CONSTRAINT "PK_abd7ef9d87682af655d923e4e87" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "atendimento_tickets" ADD "severity" character varying(20) NOT NULL DEFAULT 'MEDIA'`,
    );
    await queryRunner.query(
      `ALTER TABLE "atendimento_tickets" ADD "assigned_level" character varying(10) NOT NULL DEFAULT 'N1'`,
    );
    await queryRunner.query(
      `ALTER TABLE "atendimento_tickets" ADD "escalation_reason" character varying(255)`,
    );
    ...
    if (hasInteracoes) {
      ...
      await queryRunner.query(
        `ALTER TABLE "interacoes" ADD COLUMN IF NOT EXISTS "tipo" character varying(50) NOT NULL`,
      );
    }
    if (hasFaturas) {
      await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TABLE "dlq_reprocess_audit"`);
    await queryRunner.query(
