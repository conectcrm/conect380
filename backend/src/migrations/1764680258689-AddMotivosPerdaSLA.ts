...
export class AddMotivosPerdaSLA1764680258689 implements MigrationInterface {
  name = 'AddMotivosPerdaSLA1764680258689';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "filas_atendentes" DROP CONSTRAINT IF EXISTS "FK_filas_atendentes_user"`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "filas_atendentes" DROP CONSTRAINT IF EXISTS "FK_filas_atendentes_fila"`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "departamentos" DROP CONSTRAINT IF EXISTS "fk_departamentos_nucleo"`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "filas" DROP CONSTRAINT IF EXISTS "FK_filas_departamento"`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "filas" DROP CONSTRAINT IF EXISTS "FK_filas_nucleo"`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "atendimento_tickets" DROP CONSTRAINT IF EXISTS "FK_ticket_departamento"`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "triagem_logs" DROP CONSTRAINT IF EXISTS "fk_triagem_logs_fluxo"`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "triagem_logs" DROP CONSTRAINT IF EXISTS "fk_triagem_logs_sessao"`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "produtos" DROP CONSTRAINT IF EXISTS "FK_produtos_empresa"`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "configuracoes_gateway_pagamento" DROP CONSTRAINT IF EXISTS "FK_config_gateway_empresa"`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "contratos" DROP CONSTRAINT IF EXISTS "FK_contratos_empresa"`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "pagamentos" DROP CONSTRAINT IF EXISTS "FK_pagamentos_empresa"`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "transacoes_gateway_pagamento" DROP CONSTRAINT IF EXISTS "FK_transacoes_gateway_pagamento"`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "transacoes_gateway_pagamento" DROP CONSTRAINT IF EXISTS "FK_transacoes_gateway_fatura"`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "transacoes_gateway_pagamento" DROP CONSTRAINT IF EXISTS "FK_transacoes_gateway_config"`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "transacoes_gateway_pagamento" DROP CONSTRAINT IF EXISTS "FK_transacoes_gateway_empresa"`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "atividades" DROP CONSTRAINT IF EXISTS "FK_atividades_empresa"`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "oportunidades" DROP CONSTRAINT IF EXISTS "FK_oportunidades_cliente"`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "oportunidades" DROP CONSTRAINT IF EXISTS "FK_oportunidades_empresa"`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "leads" DROP CONSTRAINT IF EXISTS "FK_leads_oportunidade"`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "leads" DROP CONSTRAINT IF EXISTS "FK_leads_responsavel"`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "leads" DROP CONSTRAINT IF EXISTS "FK_leads_empresa"`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "faturas" DROP CONSTRAINT IF EXISTS "FK_644bf709a39af5c760b98e56a06"`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "empresa_modulos" DROP CONSTRAINT IF EXISTS "fk_empresa_modulos_empresa"`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "password_reset_tokens" DROP CONSTRAINT IF EXISTS "FK_password_reset_tokens_user"`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "atendimento_demandas" DROP CONSTRAINT IF EXISTS "FK_38d6f6cb4a5f9cca287be7e4b50"`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "atendimento_configuracao_inatividade" DROP CONSTRAINT IF EXISTS "FK_configuracao_inatividade_departamento"`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "ticket_tags" DROP CONSTRAINT IF EXISTS "FK_TICKET_TAGS_TAG"`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "ticket_tags" DROP CONSTRAINT IF EXISTS "FK_TICKET_TAGS_TICKET"`,
    );
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_users_ativo"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_notifications_user_id"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_notifications_read"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_notifications_created_at"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_notifications_user_unread"`);
    await queryRunner.query(
      `DROP INDEX IF EXISTS "public"."IDX_filas_atendentes_fila_atendente"`,
    );
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_filas_atendentes_filaId"`);
    await queryRunner.query(
      `DROP INDEX IF EXISTS "public"."IDX_filas_atendentes_atendenteId"`,
    );
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_TAGS_NOME"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_TAGS_NOME_EMPRESA"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_TAGS_ATIVO"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_TAGS_EMPRESA"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_ticket_departamento"`);
    await queryRunner.query(
      `DROP INDEX IF EXISTS "public"."IDX_atendimento_tickets_empresa_status"`,
    );
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_atendimento_tickets_created_at"`);
    await queryRunner.query(
      `DROP INDEX IF EXISTS "public"."IDX_atendimento_tickets_empresa_status_priority"`,
    );
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_atendimento_tickets_priority"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_produtos_empresa_id"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_produtos_status"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_contratos_empresa_id"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_clientes_empresa_ativo"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_clientes_empresa_ativo_created"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_itens_fatura_fatura_id"`);
    ...
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_faturas_empresa_status"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_faturas_vencimento"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_faturas_empresa_status_vencimento"`);
    ...
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_atividades_oportunidade_id"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_atividades_empresa_id"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_oportunidades_empresa_estagio"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_oportunidades_created_at"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_oportunidades_empresa_estagio_created"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_oportunidades_empresa_id"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_metas_periodo_tipo"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_metas_empresa_periodo"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_metas_ativos"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_leads_empresa_id"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_leads_status"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_leads_responsavel_id"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_leads_created_at"`);
    ...
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_contatos_cliente_id"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_password_reset_tokens_token_hash"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_password_reset_tokens_user_id"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_SLA_LOG_EMPRESA"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_SLA_LOG_TICKET"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_SLA_LOG_STATUS"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_SLA_LOG_TIPO_EVENTO"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_SLA_LOG_CREATED_AT"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_SLA_CONFIG_EMPRESA"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_SLA_CONFIG_PRIORIDADE"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_SLA_CONFIG_ATIVO"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_SLA_CONFIG_EMPRESA_PRIORIDADE"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_MESSAGE_TEMPLATES_EMPRESA"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_MESSAGE_TEMPLATES_ATIVO"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_MESSAGE_TEMPLATES_ATALHO"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_MESSAGE_TEMPLATES_CATEGORIA"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_atendimento_mensagens_ticket_id"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_atendimento_mensagens_created_at"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_configuracao_inatividade_ativo"`);
    await queryRunner.query(
      `DROP INDEX IF EXISTS "public"."IDX_configuracao_inatividade_empresa_departamento"`,
    );
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_TICKET_TAGS_TAG"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_TICKET_TAGS_TICKET"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_TICKET_TAGS_COMPOSITE"`);
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "empresas" DROP CONSTRAINT IF EXISTS "empresas_status_check"`,
    );
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "produtos" DROP CONSTRAINT IF EXISTS "UQ_produtos_empresa_sku"`,
    );
    await queryRunner.query(
      `CREATE TABLE IF NOT EXISTS "equipe_atribuicoes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "equipe_id" uuid NOT NULL, "nucleo_id" uuid, "departamento_id" uuid, "prioridade" integer NOT NULL DEFAULT '0', "ativo" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_feff7a3ca4116b573219b984939" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE IF NOT EXISTS "atendente_equipes" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "atendente_id" uuid NOT NULL, "equipe_id" uuid NOT NULL, "funcao" character varying(50) NOT NULL DEFAULT 'membro', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_298921e69f1a5860ac5d51e6543" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(`ALTER TABLE IF EXISTS "faturas" ADD COLUMN IF NOT EXISTS "empresa_id" uuid`);
    ...
    await queryRunner.query(`ALTER TABLE "empresas" ALTER COLUMN "status" SET NOT NULL`);
    await queryRunner.query(`ALTER TABLE "empresas" ALTER COLUMN "valor_mensal" SET NOT NULL`);
    await queryRunner.query(`ALTER TABLE "empresas" ALTER COLUMN "usuarios_ativos" SET NOT NULL`);
    await queryRunner.query(`ALTER TABLE "empresas" ALTER COLUMN "health_score" SET NOT NULL`);
    await queryRunner.query(
    ...
    await queryRunner.query(`ALTER TABLE IF EXISTS "metas" ALTER COLUMN "valor" DROP DEFAULT`);
    await queryRunner.query(
      `ALTER TABLE IF EXISTS "atendimento_canais" ALTER COLUMN "provedor" DROP DEFAULT`,
    );
    if (hasFaturas) {
      await queryRunner.query(
