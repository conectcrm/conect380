...
var AuthService = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, bcrypt.compare(password, user.senha)];
                    case 2:
                        _a = (_b.sent());
                        _b.label = 3;
                    case 3:
    ...
    AuthService.prototype.register = function (userData) {
        return __awaiter(this, void 0, void 0, function () {
            var existingUser, hashedPassword, user, senha, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.usersService.findByEmail(userData.email)];
                    case 1:
                        existingUser = _a.sent();
                        if (existingUser) {
                            throw new common_1.UnauthorizedException('Email já está em uso');
                        }
                        return [4 /*yield*/, bcrypt.hash(userData.senha, 10)];
                    case 2:
                        hashedPassword = _a.sent();
                        return [4 /*yield*/, this.usersService.create(__assign(__assign({}, userData), { senha: hashedPassword }))];
                    case 3:
                        user = _a.sent();
                        senha = user.senha, result = __rest(user, ["senha"]);
                        return [2 /*return*/, {
