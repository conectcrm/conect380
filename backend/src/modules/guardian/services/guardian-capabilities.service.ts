...
export type GuardianRuntimeContext = {
  environment: string;
...
@Injectable()
export class GuardianCapabilitiesService {
  constructor(private readonly configService: ConfigService) {}

  getCapabilities(): GuardianCapabilities {
    return {
  ...
  getRuntimeContext(): GuardianRuntimeContext {
    return {
      ...
      legacyTransitionMode: this.readStringValue(
  ...
  assertBreakGlassRequestCreationAllowed(): void {
    ...
    throw new ForbiddenException(
      'Solicitacao de break-glass pelo Guardian esta desabilitada. Use o fluxo operacional previsto.',
    );
  }
  ...
  assertManualBillingDueDateCycleAllowed(): void {
    ...
    throw new ForbiddenException(
      'Execucao manual do ciclo de vencimento esta desabilitada no Guardian.',
    );
  }
  ...
  assertPlanDeletionAllowed(): void {
    ...
    throw new ForbiddenException(
      'Exclusao fisica de plano esta desabilitada no Guardian. Arquive ou versione o catalogo.',
    );
  }
  ...
  assertDirectAccessRecertificationAllowed(): void {
    ...
    throw new ForbiddenException(
      'Recertificacao direta fora da fila formal esta desabilitada no Guardian.',
    );
  }
  ...
  assertCompanyModuleManagementAllowed(): void {
    ...
    throw new ForbiddenException(
      'Gestao de modulos por empresa esta desabilitada ate a publicacao oficial do catalogo Guardian.',
    );
  }
