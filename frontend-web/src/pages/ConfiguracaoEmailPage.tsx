...
const ConfiguracaoEmailPage: React.FC = () => {
  ...
  const getProviderInfo = () => EMAIL_PROVIDERS[providerAtual] || null;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h3 className="text-lg font-semibold mb-4">Escolher Provedor</h3>
              ...
              <div className="space-y-3">
                {Object.entries(EMAIL_PROVIDERS).map(([key, provider]) => (
                  <div
                    ...
                    className={`p-4 border-2 rounded-lg cursor-pointer transition-all ${providerAtual === key
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      ...
                      {providerAtual === key && <Check className="w-4 h-4 text-blue-600" />}
                    </div>
                    <p className="text-sm text-gray-600 mb-2">{provider.description}</p>
                    <div className="text-xs text-gray-500">
                      <div>📧 {provider.limits}</div>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
              <h3 className="text-lg font-semibold mb-4">Configurações do {EMAIL_PROVIDERS[providerAtual]?.name}</h3>
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                    <div className="flex">
                      ...
                      <div>
                        <h5 className="font-medium text-yellow-900 mb-1">Como obter a senha de app:</h5>
                        <ol className="text-sm text-yellow-700 list-decimal list-inside space-y-1">
                          ...
                          <li>Use essa senha de 16 caracteres (não sua senha normal)</li>
                        </ol>
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                    <div className="flex">
                      <Info className="w-4 h-4 text-blue-600 mt-0.5 mr-2 flex-shrink-0" />
                      <div>
                        <h5 className="font-medium text-blue-900 mb-1">Como obter a API Key:</h5>
            ...
            {/* Teste de E-mail */}
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h3 className="text-lg font-semibold mb-4">Testar Configuração</h3>
