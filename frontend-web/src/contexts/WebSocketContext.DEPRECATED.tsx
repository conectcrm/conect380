...
export const WebSocketProvider: React.FC<WebSocketProviderProps> = ({ children }) => {
  ...
  // ⚠️ DESABILITADO: Chat usa useWebSocket.ts próprio, evitar duplicação
  useEffect(() => {
    // ❌ Auto-connect desabilitado para evitar conflito com useWebSocket.ts
    // Se necessário, chamar reconnect() manualmente
      ...
      setTimeout(() => {
        if (globalSocket) {
          try {
            ...
            if (DEBUG) console.log('⚠️ Erro no cleanup WebSocket (esperado):', err);
          } finally {
            globalSocket = null;
          }
        }
