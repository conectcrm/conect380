...
const relatorioMock: RelatorioFinanceiro = {
  ...
  receitas: 26700.00,
  despesas: 4550.00,
  lucroLiquido: 22150.00,
  contasReceber: 8500.00,
  contasPagar: 1200.00,
  fluxoCaixa: 29350.00
};
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-green-600">{formatCurrency(relatorio.receitas)}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-red-600">{formatCurrency(relatorio.despesas)}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-blue-600">{formatCurrency(relatorio.lucroLiquido)}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-yellow-600">{formatCurrency(relatorio.contasReceber)}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-orange-600">{formatCurrency(relatorio.contasPagar)}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-purple-600">{formatCurrency(relatorio.fluxoCaixa)}</p>
            </div>
          </div>
        </div>
      </div>
