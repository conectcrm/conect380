...
const STATUS_OPTIONS: Array<{ value: string; label: string }> = [
  ...
  { value: 'dispensa_contrato_solicitada', label: 'Dispensa de contrato solicitada' },
  { value: 'dispensa_contrato_aprovada', label: 'Dispensa de contrato aprovada' },
  { value: 'faturamento_liberado', label: 'Faturamento liberado' },
