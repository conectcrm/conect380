                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-start justify-between">
                        <div>
                          ...
                          <p className="text-sm text-gray-500">{contato.cargo} - {contato.empresa}</p>
                        </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg max-w-2xl w-full p-6">
            ...
            <div className="space-y-4">
              <div>
                <strong>Email:</strong> {contatoSelecionado.email}
              </div>
              <div>
                <strong>Telefone:</strong> {contatoSelecionado.telefone}
              </div>
              <div>
                <strong>Empresa:</strong> {contatoSelecionado.empresa}
              </div>
              <div>
                <strong>Cargo:</strong> {contatoSelecionado.cargo}
              </div>
              <div>
                <strong>Status:</strong> {contatoSelecionado.status}
              </div>
            </div>
