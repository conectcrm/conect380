...
describe('KPICard', function () {
    ...
    it('deve renderizar tendência positiva corretamente', function () {
        var propsWithTrend = __assign(__assign({}, defaultProps), { trend: {
                value: 12,
                isPositive: true,
                label: 'este mês'
            } });
    ...
    it('deve usar aria-label customizado quando fornecido', function () {
        var customProps = __assign(__assign({}, defaultProps), { 'aria-label': 'Métrica personalizada de clientes' });
    ...
    it('deve aplicar classes de cor corretamente', function () {
        var rerender = (0, react_1.render)(<KPICard_1.KPICard {...defaultProps} color="green"/>).rerender;
        var card = react_1.screen.getByRole('region');
