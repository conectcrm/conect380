...
describe('ResponsiveDashboardLayout', function () {
  ...
  it('renderiza ações quando fornecidas', function () {
    ...
    (0, react_1.render)(<ResponsiveDashboardLayout_1.ResponsiveDashboardLayout {...defaultProps} actions={actions} />);
  ...
  it('configura atributos de acessibilidade corretamente', function () {
    ...
    expect(referencedHeading === null || referencedHeading === void 0 ? void 0 : referencedHeading.textContent).toBe(defaultProps.title);
  });
  it('mantém elementos interativos principais visíveis', function () {
    (0, react_1.render)(<ResponsiveDashboardLayout_1.ResponsiveDashboardLayout {...defaultProps} />);
    expect(react_1.screen.getByPlaceholderText('Buscar clientes, propostas, contratos...')).toBeInTheDocument();
