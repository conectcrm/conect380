export const shellTokens = {
  ...
  cardSoft: 'rounded-[18px] border border-[#DEE8EC] bg-[#FCFEFD] shadow-[0_12px_24px_-22px_rgba(16,57,74,0.24)]',
  ...
  input: 'h-10 rounded-xl border border-[#D4E2E7] bg-white px-3 text-sm text-[#244455] outline-none transition focus:border-[#1A9E87]/45 focus:ring-2 focus:ring-[#1A9E87]/15',
};
