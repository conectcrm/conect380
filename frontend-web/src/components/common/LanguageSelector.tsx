...
const LanguageSelector: React.FC<LanguageSelectorProps> = ({ showAsModal = false, onClose }) => {
        ...
        <div className="bg-white rounded-lg shadow-xl max-w-md w-full max-h-[80vh] overflow-hidden">
          <div className="p-6 border-b border-gray-200">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-gray-900">{t('language.select')}</h2>
          ...
          <div className="p-6">
            ...
            <div className="mt-6 pt-4 border-t border-gray-200">
              <p className="text-xs text-gray-500 text-center">{t('language.applied')}</p>
            </div>
          </div>
        </div>
      </div>
