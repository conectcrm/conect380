...
const getConfirmationConfig = (tipo: TipoConfirmacao, dados?: DadosContexto) => {
  const configs = {
    ...
    'excluir-fatura-paga': {
      ...
      description:
        'Faturas já pagas não podem ser excluídas para manter a integridade dos registros financeiros. Você pode cancelá-la se necessário.',
      confirmText: 'Entendi',
    ...
    'excluir-fatura-com-pagamentos': {
      ...
      description:
        'Esta fatura tem pagamentos associados. Excluí-la pode causar inconsistências nos relatórios financeiros. Considere cancelá-la ao invés de excluir.',
    ...
    'excluir-multiplas-faturas': {
      ...
      description:
        'Esta ação irá excluir todas as faturas selecionadas permanentemente. Verifique se nenhuma delas possui pagamentos ou está vinculada a contratos importantes.',
    ...
    'cancelar-fatura': {
      ...
      description:
        'A fatura será marcada como cancelada e não poderá mais receber pagamentos. Esta ação pode ser revertida se necessário.',
    ...
    'cancelar-fatura-vencida': {
      ...
      description:
        'Cancelar uma fatura vencida pode impactar relatórios de inadimplência. Certifique-se de que o cliente foi devidamente notificado.',
      confirmText: 'Cancelar Fatura',
      confirmColor: 'bg-red-600 hover:bg-red-700',
      severity: 'error' as const,
    },
    ...
    'excluir-contrato': {
      ...
      description:
        'Esta ação remove permanentemente o contrato do sistema. Certifique-se de que não há faturas ou pagamentos vinculados.',
    ...
    'excluir-contrato-assinado': {
      ...
      description:
        'Contratos assinados têm valor jurídico e não podem ser excluídos. Você pode cancelá-lo ou marcar como inativo se necessário.',
      confirmText: 'Entendi',
      confirmColor: 'bg-blue-600 hover:bg-blue-700',
      severity: 'error' as const,
      showCancel: false,
    ...
    'excluir-contrato-com-faturas': {
      ...
      description:
        'Este contrato tem faturas geradas. Excluí-lo pode causar problemas nos registros financeiros. Exclua primeiro as faturas vinculadas.',
      confirmText: 'Excluir Mesmo Assim',
      confirmColor: 'bg-red-600 hover:bg-red-700',
      severity: 'error' as const,
    },
    ...
    'excluir-pagamento': {
      ...
      description:
        'Esta ação remove o pagamento do sistema e pode afetar o status da fatura associada. Use com cuidado para manter a integridade financeira.',
    ...
    'estornar-pagamento': {
      ...
      description:
        'O estorno irá reverter este pagamento e alterar o status da fatura para pendente. Esta ação deve ser usada apenas em casos de erro ou devolução autorizada.',
    ...
    'excluir-transacao': {
      ...
      description:
        'A transação será removida permanentemente dos registros financeiros. Isso pode afetar relatórios e balanços contábeis.',
    ...
    'excluir-categoria-financeira': {
      ...
      description:
        'Todas as transações vinculadas a esta categoria ficarão sem classificação. Considere reclassificar as transações antes de excluir.',
    ...
    'excluir-plano-cobranca': {
      ...
      description:
        'O plano será removido permanentemente. Certifique-se de que não há assinaturas ativas utilizando este plano.',
    ...
    'cancelar-assinatura': {
      ...
      description:
        'A assinatura será cancelada e não gerará mais faturas automáticas. O cliente perderá acesso aos serviços no próximo ciclo.',
    ...
    'pausar-assinatura': {
      ...
      description:
        'A assinatura será pausada temporariamente. Não serão geradas faturas até que seja reativada.',
    ...
    'alterar-plano-assinatura': {
      ...
      description:
        'A alteração será aplicada no próximo ciclo de cobrança. O valor e condições seguirão as regras do novo plano.',
    ...
    'excluir-backup-financeiro': {
      ...
      description:
        'Esta é uma ação irreversível. O backup será permanentemente removido e não poderá ser recuperado.',
    ...
    'restaurar-backup': {
      ...
      description:
        'ATENÇÃO: Esta ação irá substituir todos os dados financeiros atuais pelos dados do backup. Todas as alterações feitas após a data do backup serão perdidas.',
    ...
    'limpar-dados-financeiros': {
      ...
      description:
        'ATENÇÃO: Esta ação irá remover PERMANENTEMENTE todas as faturas, pagamentos, contratos e transações. Esta ação NÃO PODE ser desfeita.',
    ...
    'resetar-configuracoes': {
      ...
      description:
        'As configurações voltarão aos valores padrão. Seus dados financeiros não serão afetados, apenas as preferências e personalizações.',
        ...
        <div className="relative bg-white rounded-lg shadow-xl max-w-md w-full">
          ...
          <div className={`px-6 py-4 border-b ${getSeverityColors(config.severity)}`}>
            <div className="flex items-center">
              <div
                className={`flex-shrink-0 w-10 h-10 rounded-full ${config.severity === 'error' ? 'bg-red-100' : config.severity === 'warning' ? 'bg-amber-100' : 'bg-blue-100'} flex items-center justify-center`}
              >
          ...
          <div className="px-6 py-4">
            <div className="mb-4">
              <p className="text-sm font-medium text-gray-900 mb-2">{config.message}</p>
