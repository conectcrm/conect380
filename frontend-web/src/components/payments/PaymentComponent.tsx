      ...
      <Card className="w-full max-w-md mx-auto">
        ...
        <CardContent className="space-y-4">
          ...
          {pixData.point_of_interaction?.transaction_data?.qr_code_base64 && (
            <div className="text-center">
              <img
                src={mercadoPagoService.gerarQRCodePix(
                  pixData.point_of_interaction.transaction_data.qr_code_base64,
                )}
                alt="QR Code PIX"
          ...
          <Alert>
            <AlertDescription>
              Escaneie o QR Code ou copie e cole o código PIX no seu app bancário. O pagamento será
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              <Input
                ...
                onChange={(e) =>
                  setDadosCartao((prev) => ({ ...prev, vencimento: e.target.value }))
                }
              />
              <Input
                placeholder="CVV"
            ...
            <Select
              ...
              onValueChange={(value) =>
                setDadosCartao((prev) => ({ ...prev, parcelas: parseInt(value) }))
              }
            >
              <SelectTrigger>
