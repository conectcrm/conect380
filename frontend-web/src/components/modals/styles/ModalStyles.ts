...
export const ModalStyles = {
  ...
  // Container do modal
  container: {
    small: "bg-white rounded-xl shadow-2xl w-full max-w-md mx-auto max-h-[85vh] overflow-hidden flex flex-col",
    medium: "bg-white rounded-xl shadow-2xl w-full max-w-2xl mx-auto max-h-[85vh] overflow-hidden flex flex-col",
    large: "bg-white rounded-xl shadow-2xl w-full max-w-4xl mx-auto max-h-[85vh] overflow-hidden flex flex-col",
    extraLarge: "bg-white rounded-xl shadow-2xl w-full max-w-6xl mx-auto h-[85vh] max-h-[95vh] overflow-hidden flex flex-col"
  },
  ...
  form: {
    ...
    input: "w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#159A9C] focus:border-transparent text-sm",
    select: "w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#159A9C] focus:border-transparent text-sm",
    textarea: "w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#159A9C] focus:border-transparent text-sm",
    fieldSpacing: "mb-1",
    helpSpacing: "ml-1",
    errorSpacing: "mt-1"
  },
  ...
  // Botões
  button: {
    primary: "flex items-center px-4 py-2 bg-gradient-to-r from-[#159A9C] to-[#0F7B7D] text-white rounded-lg hover:shadow-lg disabled:bg-gray-300 disabled:cursor-not-allowed transition-all text-sm",
    secondary: "flex items-center px-3 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors text-sm",
    success: "flex items-center px-3 py-2 border border-green-300 text-green-700 rounded-lg hover:bg-green-50 transition-colors text-sm",
    warning: "flex items-center px-3 py-2 border border-amber-300 text-amber-700 rounded-lg hover:bg-amber-50 transition-colors text-sm",
    danger: "flex items-center px-3 py-2 border border-red-300 text-red-700 rounded-lg hover:bg-red-50 transition-colors text-sm",
