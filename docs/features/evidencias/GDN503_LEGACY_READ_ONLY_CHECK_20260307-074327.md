...
- RunId: 20260307-074327
- Inicio: 2026-03-07 07:43:27
- Fim: 2026-03-07 07:43:34
- DuracaoSegundos: 7.16
- DryRun: false
- Status: PASS
...
PASS src/modules/admin/guards/legacy-admin-transition.guard.spec.ts (5.749 s)
  LegacyAdminTransitionGuard
    ...
    âˆš bloqueia rotas admin no modo guardian_only (12 ms)
    ...
    âˆš bloqueia escrita em canary quando request permanece no legado e read-only ativo (4 ms)

Test Suites: 1 passed, 1 total
Tests:       7 passed, 7 total
Snapshots:   0 total
Time:        6.028 s, estimated 11 s
