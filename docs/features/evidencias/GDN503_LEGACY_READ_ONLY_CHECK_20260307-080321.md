...
- Inicio: 2026-03-07 08:03:21
- Fim: 2026-03-07 08:03:28
...
PASS src/modules/admin/guards/legacy-admin-transition.guard.spec.ts (5.585 s)
  LegacyAdminTransitionGuard
    ...
    âˆš permite leitura no legado quando read-only ativo e sinaliza header (5 ms)
    âˆš bloqueia escrita em canary quando request permanece no legado e read-only ativo (1 ms)

Test Suites: 1 passed, 1 total
Tests:       7 passed, 7 total
Snapshots:   0 total
Time:        5.831 s, estimated 6 s
