...
- Inicio: 2026-02-28 14:38:35
- Fim: 2026-02-28 14:39:41
- Total: 6
- PASS: 6
- FAIL: 0
...
| --- | --- | --- | ---: | ---: |
| REG-001 | E2E vendas/faturamento/webhook gateway | PASS | 17.17 | 0 |
| REG-002 | E2E financeiro contas a pagar/exportacao | PASS | 12.1 | 0 |
| REG-003 | Unit webhook gateway | PASS | 8.07 | 0 |
| REG-004 | Unit monitor/alertas financeiros | PASS | 13.13 | 0 |
| REG-005 | E2E conciliacao bancaria | PASS | 12.12 | 0 |
| REG-006 | Frontend contratos/estado financeiro | PASS | 3.05 | 0 |
