...
- RunId: 20260228-102216
- Inicio: 2026-02-28 10:22:16
- Fim: 2026-02-28 10:23:15
- Total: 6
- PASS: 6
- FAIL: 0
...
| --- | --- | --- | ---: | ---: |
| REG-001 | E2E vendas/faturamento/webhook gateway | PASS | 14.14 | 0 |
| REG-002 | E2E financeiro contas a pagar/exportacao | PASS | 13.1 | 0 |
| REG-003 | Unit webhook gateway | PASS | 8.09 | 0 |
| REG-004 | Unit monitor/alertas financeiros | PASS | 8.07 | 0 |
| REG-005 | E2E conciliacao bancaria | PASS | 12.15 | 0 |
| REG-006 | Frontend contratos/estado financeiro | PASS | 4.04 | 0 |
...
- REG-006: cd C:\Projetos\conect360\frontend-web && npm test -- --watch=false --runInBand src/services/__tests__/contasPagarService.test.ts src/services/__tests__/alertasOperacionaisFinanceiroService.test.ts src/features/dashboard-v2/__tests__/financeiro-alertas-state.test.ts
