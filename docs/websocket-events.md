...
> Documentação completa dos eventos WebSocket implementados no sistema de atendimento omnichannel
...
**Comportamento:**
- Cliente entra na sala `ticket:{ticketId}`
- Passa a receber eventos específicos desse ticket
