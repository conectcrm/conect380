...
# Comando executado:
Invoke-RestMethod -Uri "http://localhost:3001/api/atendimento/webhooks/whatsapp/<ID_EMPRESA>" -Method Post -Headers @{"X-Hub-Signature-256" = "sha256=..."}
...
**O que funcionou:**
1. ✅ Rota `/api/atendimento/webhooks/whatsapp/:empresaId` existe e valida `X-Hub-Signature-256`
